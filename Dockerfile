...
RUN echo "#!/bin/sh\n(\necho \"Date: \`date\`\"\necho \"Command: \$*\"\nPYTHONPATH=/home/${USER_NAME}/tools/FastBATLLNN-VNNCOMP/FastBATLLNN:/home/${USER_NAME}/tools/FastBATLLNN-VNNCOMP/FastBATLLNN/HyperplaneRegionEnum:/home/${USER_NAME}/tools/FastBATLLNN-VNNCOMP/FastBATLLNN/TLLnet:/home/${USER_NAME}/tools/FastBATLLNN-VNNCOMP/nnenum/src/nnenum nohup \"\$@\"\necho \"Completed: \`date\`\"\necho\n) >>\${LOGFILE:=FastBATLLNN_server_log.out} 2>&1 &" > /usr/local/bin/bk
...
RUN echo "#!/bin/bash\n/usr/sbin/sshd -D &> /root/nohup.out &\nif [ -e /etc/ssh/ssh_host_rsa_key.pub ]\nthen\n echo \"\n****** SSH host key ******\"\ncat /etc/ssh/ssh_host_rsa_key.pub\necho \"**************************\n\"\nsudo -u \$1 cp /etc/ssh/ssh_host_rsa_key.pub /home/\$1/results\nfi\nif [ -e /home/\$1/results/authorized_keys ] && [ -d /home/\$1/.ssh ]\nthen\ncp /home/\$1/results/authorized_keys /home/\$1/.ssh\nchmod 600 /home/\$1/.ssh/authorized_keys && chown \$1:\$1 /home/\$1/.ssh/authorized_keys && rm /home/\$1/results/authorized_keys\nfi\nsudo -u \$1 PYTHONPATH=/home/${USER_NAME}/tools/FastBATLLNN-VNNCOMP/FastBATLLNN:/home/${USER_NAME}/tools/FastBATLLNN-VNNCOMP/FastBATLLNN/HyperplaneRegionEnum:/home/${USER_NAME}/tools/FastBATLLNN-VNNCOMP/FastBATLLNN/TLLnet:/home/${USER_NAME}/tools/FastBATLLNN-VNNCOMP/nnenum/src/nnenum charmrun +p${CORES} /home/\$1/tools/FastBATLLNN-VNNCOMP/FastBATLLNN/FastBATLLNNServer.py &> /home/\$1/FastBATLLNN_server_log.out &\nif [ \"\$2\" = \"-d\" ]; then\nwait -n\nelse\nsudo -u \$1 /bin/bash\nfi" > /usr/local/bin/startup.sh
